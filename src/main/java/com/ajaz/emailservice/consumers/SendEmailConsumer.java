package com.ajaz.emailservice.consumers;

import com.ajaz.emailservice.dtos.SendEmailMessageDto;
import com.ajaz.emailservice.utilities.EmailUtil;
    ...
    public void handleSendEmail(String message) throws JsonProcessingException {
        ...
        Authenticator auth = new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication(emailMessage.getFrom(), "");
            }
        };
